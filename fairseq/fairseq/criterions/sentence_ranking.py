...
class SentenceRankingCriterion(FairseqCriterion):
    def __init__(self, task, ranking_head_name, save_predictions, num_classes):
        ...
        # concepts = torch.load('/mnt/phily/commonsense/knowledge.bin').type(torch.LongTensor)
        # concepts = torch.load('/mnt/phily/social_iqa/knowledge.bin').type(torch.LongTensor)
        # self.concepts = utils.move_to_cuda(concepts)
